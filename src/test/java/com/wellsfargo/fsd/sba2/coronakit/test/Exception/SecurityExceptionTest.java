package com.wellsfargo.fsd.sba2.coronakit.test.Exception;

import static com.wellsfargo.fsd.sba2.coronakit.test.utils.TestUtils.currentTest;
import static com.wellsfargo.fsd.sba2.coronakit.test.utils.TestUtils.exceptionTestFile;
import static com.wellsfargo.fsd.sba2.coronakit.test.utils.TestUtils.yakshaAssert;
...
import com.wellsfaro.fsd.sba2.coronakit.controller.AdminController;
import com.wellsfaro.fsd.sba2.coronakit.controller.UserController;
...
public class SecurityExceptionTest {
	...
	public void testMainMenuPageInvalidCredentials() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/home") // R : custom-login
				.with(user("admin").password("1234").roles("XYZ"));	// custom-error F				
	...
	public void testAdminHomeInvalidCredential() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/admin/home")
				.with(user("admin").password("1234").roles("XYZ"));					
	...
	public void testUserHomeInvalidCredential() throws Exception {
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/user/home")
				.with(user("usera").password("1234").roles("XYZ"));					
